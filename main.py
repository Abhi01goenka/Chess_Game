...
def is_checkmate(dest, board):
    ...
    if piece[0] == "P":
        ...
        if abs(ind.index(pos[0]) - ind.index(dest[0])) == 0 and abs(
            int(pos[1]) - int(dest[1])) == 1:
            return True
        if abs(ind.index(pos[0]) - ind.index(dest[0])) == 1 and abs(
            int(pos[1]) - int(dest[1])) == 0:
            return True
        if abs(ind.index(pos[0]) - ind.index(dest[0])) == 1 and abs(
            int(pos[1]) - int(dest[1])) == 1:
            return True
...
def valid_move(src, dest, board):
    ...
    if src_piece in ["K1", "K2"]:
        if abs(ind.index(src[0]) - ind.index(dest[0])) == 0 and abs(
            int(src[1]) - int(dest[1])) == 1:
            return True
        if abs(ind.index(src[0]) - ind.index(dest[0])) == 1 and abs(
            int(src[1]) - int(dest[1])) == 0:
            return True
        if abs(ind.index(src[0]) - ind.index(dest[0])) == 1 and abs(
            int(src[1]) - int(dest[1])) == 1:
            return True
